...
public class BadakLangLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"INT", "DOUBLE", "CHAR", "STRING", "BOOL", "VOID", "CONST", "FUNC", "IF", 
			"ELSE", "WHILE", "FOR", "RETURN", "PRINT", "INPUT", "AND", "OR", "NOT", 
			"NULL", "DICT", "NEW", "LENGTH", "APPEND", "REMOVE", "HASKEY", "CLEAR", 
			"KEYS", "VALUES", "BOOLEAN", "INTEGER_LITERAL", "DOUBLE_LITERAL", "CHAR_LITERAL", 
			"STRING_LITERAL", "ADD", "SUB", "MUL", "DIV", "MOD", "ASSIGN", "ADD_ASSIGN", 
			"SUB_ASSIGN", "MUL_ASSIGN", "DIV_ASSIGN", "EQ", "NEQ", "LT", "GT", "LEQ", 
			"GEQ", "LPAREN", "RPAREN", "LBRACE", "RBRACE", "LBRACKET", "RBRACKET", 
			"COMMA", "COLON", "SEMI", "IDENTIFIER", "LINE_COMMENT", "BLOCK_COMMENT", 
			"WS", "NEWLINE"
		};
	}
	...
	public BadakLangLexer(CharStream input) {
		super(input);
